export const querys = {
    getAllFoods: 'SELECT idPlato,nombre,descripcion,round(precio, 0, 1)precio,platoDia,nombreCat FROM plato INNER JOIN Categoria AS c ON c.idCategoria = plato.idCategoria ORDER BY plato.idCategoria',
    ...
    insertDishOfDay:'INSERT INTO PlatoDelDia VALUES (@nombre,@descripcion,default)',
    getDishOfDay: 'SELECT'
}