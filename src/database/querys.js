export const querys = {
    ...
    updatePriceByCategory: 'UPDATE plato SET precio = (precio + precio * @aumento) FROM plato AS p INNER JOIN categoria AS c ON p.idCategoria = c.idCategoria WHERE c.nombreCat = @categoriaAumento'
}